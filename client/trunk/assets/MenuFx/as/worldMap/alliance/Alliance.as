...
function SetContent()
{
	info.desc_title.pop_title.coord_text.htmlText           =UIData.coordinate
	info.desc_title.pop_title.m_type.htmlText                =UIData.mType
	info.info.battle_number.htmlText                             =UIData.battleNumber
	info.info.base_number.htmlText                               =UIData.baseNumber
}

function SetButton()
{
	var btns=info.tab_bottom
	btns.btn_backbase.onRelease=function()
	{
		fscommand("MapCommand","BackDefense")
	}

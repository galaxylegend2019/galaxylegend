...
class common.CListBox extends MovieClip
{
    var m_itemKeyList                   = null
    var m_itemMCList                    = null
    var m_freeMCList                    = null
    ...
    */
    ...
    function setTotolOffsetSlide(offset)
    {
    ...
    function onReleasedInListbox()
    {
       ...
       //     trace("fuck inertialOffset " + m_inertiaOffset)
            ...
            if (totalBackLen < - m_hitZone_panel._height*0.42){

                if(m_this.onGetMoreMessage)
                {
                    m_this.onGetMoreMessage()
                }
            }
        }
    }
